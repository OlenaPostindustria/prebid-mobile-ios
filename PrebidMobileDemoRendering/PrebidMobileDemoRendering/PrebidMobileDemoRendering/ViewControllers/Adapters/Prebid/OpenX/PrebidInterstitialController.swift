...
class PrebidInterstitialController: NSObject, AdaptedController, PrebidConfigurableController, InterstitialAdUnitDelegate {
    ...
    private var interstitialController : PBRInterstitialAdUnit?
    ...
    func loadAd() {
        ...
        interstitialController = PBRInterstitialAdUnit(configID: prebidConfigId,
    ...
    func interstitialDidReceiveAd(_ interstitial: PBRInterstitialAdUnit) {
        adapterViewController?.showButton.isEnabled = true
        interstitialDidReceiveAdButton.isEnabled = true
    }

    func interstitial(_ interstitial: PBRInterstitialAdUnit, didFailToReceiveAdWithError error: Error?) {
        interstitialDidFailToReceiveAdButton.isEnabled = true
    }
    
    func interstitialWillPresentAd(_ interstitial: PBRInterstitialAdUnit) {
        interstitialWillPresentAdButton.isEnabled = true
    }
    
    func interstitialDidDismissAd(_ interstitial: PBRInterstitialAdUnit) {
        interstitialDidDismissAdButton.isEnabled = true
    }
    
    func interstitialWillLeaveApplication(_ interstitial: PBRInterstitialAdUnit) {
        interstitialWillLeaveApplicationButton.isEnabled = true
    }
    
    func interstitialDidClickAd(_ interstitial: PBRInterstitialAdUnit) {
